...
const ITEMS = [
  ...
  { domain: "Money & payments", survival: true, why: "If payroll or supplier payments can't run without you, a single absence puts your staff and key suppliers at risk.", action: "Delegate payment approval up to a set limit, and confirm payroll can run and be approved without you." },
  ...
  { domain: "Purchasing & suppliers", survival: true, why: "When buying waits for your sign-off, you get stock-outs and firefighting instead of a supply chain that just runs.", action: "Set reorder rules and a purchase-order and invoice approval limit so buying doesn't wait for you." },
  ...
  { domain: "People, operations & delivery", survival: true, why: "If leave, rosters and discipline route through you, day-to-day operations stall the moment you're not there.", action: "Give a manager written authority over leave, rosters and first-line discipline." },
